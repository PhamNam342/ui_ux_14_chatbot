    ...
    <AppShell role="advisor">
      <div className="content-form">
        ...
        <Card>
          ...
          <div className="mt-8 flex gap-3 border-t border-slate-200 pt-6"><Button>✓ Lưu dữ liệu</Button><Link to="/advisor/data"><Button variant="ghost">Hủy</Button></Link><Link to="/advisor/import"><Button variant="outline">Nhập CSV</Button></Link></div>
        </Card>
      </div>
    </AppShell>
  )
