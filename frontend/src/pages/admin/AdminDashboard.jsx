...
export function AdminDashboard() {
  ...
  function saveDoctor(event) {
    ...
    const roomValue = form.get('room') || 'Phòng 102'
      ...
      <div className="content-wide">
        ...
        <Card className="mb-7">
          <div className="grid gap-4 lg:grid-cols-[1.3fr_1fr_1fr]">
            <div><label className="field-label">Tìm kiếm</label><SearchBar value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Tên, mã số hoặc số điện thoại..." /></div>
